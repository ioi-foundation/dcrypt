...
- external cryptographic implementations exist only as isolated candidate
  comparators outside the published dependency graph.

The release also passed the then-named oracle-comparison, interoperability, target,
...
oracle-lineage finding, security audit, formal verification, FIPS validation, or a blanket

...
This candidate currently has a **final-subject-candidate-review-required** binding. It binds source commit `276b78f9b3c2aed91d2548ab9add721c434ded06`, source tree `c47c98062c43463818bb61bd3eed75ebaf189e1d`, canonical `assurance/subject-manifest.json` SHA-256 `d48d134daa383fb12c03e45aebe3bcf16f40e2c6930e17f209e0af95f1133eb4` (1,511 owned subject files under include policy `production-and-evidence-v1`), and `assurance/curated-operations.toml` SHA-256 `082cc81db8f9fcd9222b195af43208040811ae5f2e5e4565c249fecf6e10dcc8`. The curated-operations binding is required because the ECIES table retains support classifications.
